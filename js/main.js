...
const store = Vuex.createStore({
  ...
  mutations: {
    ...
    clear_reg_login_form(state) {
      (state.reg_user_name = ""), (state.reg_password = "");
    },
    clear_thread(state) {
...
const navigation = {
  computed: {
    ...Vuex.mapState(["online", "users_online", "thread"]),
    ...Vuex.mapGetters([]),
  },
  methods: {
    ...Vuex.mapMutations([]),
...
const login = {
  computed: {
    ...Vuex.mapState(["user_name", "password", "to_login", "access_token"]),
    ...Vuex.mapGetters([]),
    password: {
      get() {
  ...
  methods: {
    ...Vuex.mapMutations([
      ...
      "user_name_updator",
      "update_to_login",
      "reg_password_updator",
      "reg_user_name_updator",
    ]),
    async authenticate() {
...
const msg_form = {
  ...
  methods: {
    ...Vuex.mapMutations(["messageUpdator", "addMessage"]),
    async sendMessage() {
